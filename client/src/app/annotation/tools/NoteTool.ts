...
import {Canvas as ICanvas, Object as IObject} from "fabric";
...
export class NoteTool implements Tool {
    ...
    editItem(object: IObject, annotation: BaseAnnotation) {
        (<NoteAnnotation>annotation.data).x = object.getLeft() * am.getScaleValue();
        (<NoteAnnotation>annotation.data).y = object.getTop() * am.getScaleValue();
        return annotation;
    }
